...
decodePairOfFloatArrays =
    Decode.map2 makePair (Decode.index 0 decodeFloatArray) (Decode.index 1 decodeFloatArray)


decodePairOfIntFloatArrays : Decode.Decoder ( Array Int, Array Float )
decodePairOfIntFloatArrays =
    Decode.map2 makePair (Decode.index 0 decodeIntArray) (Decode.index 1 decodeFloatArray)
